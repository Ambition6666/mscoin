...
func (c *marketClient) FindSymbolThumb(ctx context.Context, in *MarketReq, opts ...grpc.CallOption) (*SymbolThumbRes, error) {
	out := new(SymbolThumbRes)
	err := c.cc.Invoke(ctx, "/market.Market/FindSymbolThumb", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *marketClient) FindVisibleExchangeCoins(ctx context.Context, in *MarketReq, opts ...grpc.CallOption) (*ExchangeCoinRes, error) {
	out := new(ExchangeCoinRes)
	err := c.cc.Invoke(ctx, "/market.Market/FindVisibleExchangeCoins", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MarketServer interface {
	FindSymbolThumb(context.Context, *MarketReq) (*SymbolThumbRes, error)
	...
	FindVisibleExchangeCoins(context.Context, *MarketReq) (*ExchangeCoinRes, error)
...
func (UnimplementedMarketServer) FindSymbolThumb(context.Context, *MarketReq) (*SymbolThumbRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindSymbolThumb not implemented")
}
...
func (UnimplementedMarketServer) FindVisibleExchangeCoins(context.Context, *MarketReq) (*ExchangeCoinRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindVisibleExchangeCoins not implemented")
}
...
func _Market_FindSymbolThumb_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarketReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MarketServer).FindSymbolThumb(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.Market/FindSymbolThumb",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MarketServer).FindSymbolThumb(ctx, req.(*MarketReq))
	}
...
func _Market_FindVisibleExchangeCoins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarketReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MarketServer).FindVisibleExchangeCoins(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/market.Market/FindVisibleExchangeCoins",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MarketServer).FindVisibleExchangeCoins(ctx, req.(*MarketReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Market_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindSymbolThumb",
			Handler:    _Market_FindSymbolThumb_Handler,
		},
		{
		...
		{
			MethodName: "FindVisibleExchangeCoins",
			Handler:    _Market_FindVisibleExchangeCoins_Handler,
		},
		{
