...
var file_register_proto_goTypes = []interface{}{
	(*RegReq)(nil),     // 0: asset.RegReq
	(*CaptchaReq)(nil), // 1: asset.CaptchaReq
	(*RegRes)(nil),     // 2: asset.RegRes
	(*NoRes)(nil),      // 3: asset.NoRes
	(*CodeReq)(nil),    // 4: asset.CodeReq
}
var file_register_proto_depIdxs = []int32{
	1, // 0: asset.RegReq.captcha:type_name -> asset.CaptchaReq
	0, // 1: asset.Register.registerByPhone:input_type -> asset.RegReq
	4, // 2: asset.Register.sendCode:input_type -> asset.CodeReq
	2, // 3: asset.Register.registerByPhone:output_type -> asset.RegRes
	3, // 4: asset.Register.sendCode:output_type -> asset.NoRes
