...
func (c *memberClient) FindMemberById(ctx context.Context, in *MemberReq, opts ...grpc.CallOption) (*MemberRes, error) {
	out := new(MemberRes)
...
type MemberServer interface {
	FindMemberById(context.Context, *MemberReq) (*MemberRes, error)
...
func (UnimplementedMemberServer) FindMemberById(context.Context, *MemberReq) (*MemberRes, error) {
